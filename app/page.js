    ...
    <div className="animate-fade-in">
      ...
      {user && !user.verified && (
        <div className="container" style={{ paddingTop: '20px' }}>
          <div className="glass-card" style={{ background: 'linear-gradient(135deg, #4B184C 0%, #6d236f 100%)', border: 'none', color: 'white', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '20px' }}>
            ...
            <a href="/profile?verify=true" className="btn-primary" style={{ background: 'white', color: '#4B184C', whiteSpace: 'nowrap' }}>Get Verified Now</a>
          </div>
        </div>
      )}
      ...
      <section style={{
        ...
        <div style={{ display: 'flex', gap: '20px' }}>
          ...
          <a href="/feed" className="btn-outline">View Activity</a>
        </div>
      </section>
      ...
      <div className="container">
          ...
          <div className="grid-3">
            <div className="glass-card" style={{ padding: '0', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '24px' }}>
                ...
                <a href="/explore?type=restaurant" className="btn-primary" style={{ width: '100%' }}>Book Table</a>
              </div>
            </div>
            ...
            <div className="glass-card" style={{ padding: '0', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '24px' }}>
                ...
                <a href="/explore?type=coworking" className="btn-primary" style={{ width: '100%' }}>Book Workspace</a>
              </div>
            </div>
            ...
            <div className="glass-card" style={{ padding: '0', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '24px' }}>
                ...
                <a href="/events" className="btn-primary" style={{ width: '100%' }}>Attend Events</a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section style={{ marginBottom: '100px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '40px' }}>
            ...
            <a href="/explore" style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: '600' }}>View All →</a>
          </div>
