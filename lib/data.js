...
export let activityFeed = [
    {
        id: 'p1',
        user: { name: 'Alex Rivera', email: 'alex@trills.com', avatar: 'https://i.pravatar.cc/150?u=alex', verified: true },
    ...
    {
        id: 'p2',
        user: { name: 'Sarah Jenkins', email: 'sarah@trills.com', avatar: 'https://i.pravatar.cc/150?u=sarah', verified: true },
    ...
    {
        id: 'p3',
        user: { name: 'Marcus Chen', email: 'marcus@trills.com', avatar: 'https://i.pravatar.cc/150?u=marcus', verified: true },
    ...
    {
        id: 'p4',
        user: { name: 'Maya Iyer', email: 'maya@trills.com', avatar: 'https://i.pravatar.cc/150?u=maya', verified: true },
        content: 'I am putting together a small intro circle for new members this week. Share what you are building and I will help route the right people your way.',
        likes: 18,
        comments: 4,
...
export let mockConnections = [
    { id: 'c1', name: 'Sarah Jenkins', email: 'sarah@trills.com', designation: 'UX Lead @ Google', avatar: 'https://i.pravatar.cc/150?u=sarah', mutual: true, verified: true, isBot: true },
    { id: 'c2', name: 'Marcus Chen', email: 'marcus@trills.com', designation: 'Founding Engineer @ Vercel', avatar: 'https://i.pravatar.cc/150?u=marcus', mutual: true, verified: true, isBot: true },
    { id: 'c3', name: 'Elena Rodriguez', email: 'elena@trills.com', designation: 'Product Manager @ Meta', avatar: 'https://i.pravatar.cc/150?u=elena', mutual: false, verified: true, isBot: true },
    { id: 'c4', name: 'Maya Iyer', email: 'maya@trills.com', designation: 'Startup Operator', avatar: 'https://i.pravatar.cc/150?u=maya', mutual: true, verified: true, isBot: true },
];
